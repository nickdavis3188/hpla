    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="<?php echo $form ?>">Form</a></li>
      ...
      <div class="header-social-links d-flex align-items-center">
        ...
        <a href="https://www.facebook.com/profile.php?id=100095159199915&mibextid=ZbWKwL" class="facebook"><i class="bi bi-facebook"></i></a>
    ...
    <section id="what-we-do" class="what-we-do">
      <div class="container">
        ...
        <div class="section-title">
          <h2>What We Do</h2>
          <p>Career & Entrepreneurship Series</p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="icon-box">
              ...
              <p>We will dive into the realm of entrepreneurial ventures dedicated to providing insights into the unique challenges and opportunities that arise in this specialized field.</p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="icon-box">
              ...
              <h4><a href="">Data Science & Business Analysis</a></h4>
              <p>The combined efforts of data scientists and business analysts empower organizations to harness the full potential of their data, make data-driven decisions, and stay ahead of the competition.</p>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="icon-box">
              <div class="icon"><i class="bx bx-card"></i></div>
              <h4><a href="">Branding And Digital Communication</a></h4>
              <p>In the digital age, branding and digital communication have become inseparable allies in shaping a company's image, fostering customer engagement, and driving business growth. </p>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0">
            <h3>About Us</h3>
            <p>
              Welcome to the <span>HIS PRESENCE LIFE ACADEMY</span>, an insightful journey into the world of professional growth and entrepreneurial endeavors. In this series, we will explore the key elements that contribute to a thriving career and the mindset required to excel as an entrepreneur. Whether you're a seasoned professional or just starting your journey, this series aims to provide valuable insights and guidance to unleash your potential for success.
            </p>
            <ul>
              <li><i class="bx bx-check-double"></i>Delve into various strategies to help you uncover your true calling.</li>
              <li><i class="bx bx-check-double"></i> explore the art of setting clear, measurable, and achievable goals.</li>
            </ul>
            <div class="row icon-boxes">
              <div class="col-md-6">
                <i class="bx bx-receipt"></i>
                <h4>Discovering Your Passion</h4>
                <p>The first step towards building a successful career or entrepreneurial venture is identifying your passion.</p>
              </div>
              <div class="col-md-6 mt-4 mt-md-0">
                <i class="bx bx-cube-alt"></i>
                <h4>Setting Clear Goals</h4>
                <p>Goal setting is essential for progress in any career or business venture.</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="social-links text-center text-md-right pt-3 pt-md-0">
        ...
        <a href="https://www.facebook.com/profile.php?id=100095159199915&mibextid=ZbWKwL" class="facebook"><i class="bx bxl-facebook"></i></a>
